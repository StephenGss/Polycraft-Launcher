...
namespace Json
{
class POLYCRAFTLAUNCHER_LOGIC_EXPORT JsonException : public ::Exception
{
public:
...
POLYCRAFTLAUNCHER_LOGIC_EXPORT void write(const QJsonDocument &doc, const QString &filename);
/// @throw FileSystemException
POLYCRAFTLAUNCHER_LOGIC_EXPORT void write(const QJsonObject &object, const QString &filename);
/// @throw FileSystemException
POLYCRAFTLAUNCHER_LOGIC_EXPORT void write(const QJsonArray &array, const QString &filename);

POLYCRAFTLAUNCHER_LOGIC_EXPORT QByteArray toBinary(const QJsonObject &obj);
POLYCRAFTLAUNCHER_LOGIC_EXPORT QByteArray toBinary(const QJsonArray &array);
POLYCRAFTLAUNCHER_LOGIC_EXPORT QByteArray toText(const QJsonObject &obj);
POLYCRAFTLAUNCHER_LOGIC_EXPORT QByteArray toText(const QJsonArray &array);

/// @throw JsonException
POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonDocument requireDocument(const QByteArray &data, const QString &what = "Document");
/// @throw JsonException
POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonDocument requireDocument(const QString &filename, const QString &what = "Document");
/// @throw JsonException
POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonObject requireObject(const QJsonDocument &doc, const QString &what = "Document");
/// @throw JsonException
POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonArray requireArray(const QJsonDocument &doc, const QString &what = "Document");
...
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT double requireIsType<double>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT bool requireIsType<bool>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT int requireIsType<int>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonObject requireIsType<QJsonObject>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonArray requireIsType<QJsonArray>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QJsonValue requireIsType<QJsonValue>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QByteArray requireIsType<QByteArray>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QDateTime requireIsType<QDateTime>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QVariant requireIsType<QVariant>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QString requireIsType<QString>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QUuid requireIsType<QUuid>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QDir requireIsType<QDir>(const QJsonValue &value, const QString &what);
/// @throw JsonException
template<> POLYCRAFTLAUNCHER_LOGIC_EXPORT QUrl requireIsType<QUrl>(const QJsonValue &value, const QString &what);
