...
void AnalyticsWizardPage::retranslate()
{
    ...
    textBrowser->setHtml(tr(
        "<html><body>"
        "<p>PolycraftLauncher sends anonymous usage statistics on every start of the application. This helps us decide what platforms and issues to focus on.</p>"
        ...
        "<ul><li>A random unique ID of the PolycraftLauncher installation.<br />It is stored in the application settings (polycraftlauncher.cfg).</li>"
        "<li>Anonymized (partial) IP address.</li>"
        "<li>PolycraftLauncher version.</li>"
